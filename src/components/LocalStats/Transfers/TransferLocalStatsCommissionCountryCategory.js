...
import {
  APPKEY,
  ChooseCountry,
  LOCAL_STATS_COMMISSION_COUNTRY_TRANSFER_CATEGORY_WEEK,
...
export default (props) => {
  ...
  const getSuccessfulPaymentCommissionCountryCategory = () => {
    ...
    setErrorData(null);
    axios
      .get(LOCAL_STATS_COMMISSION_COUNTRY_TRANSFER_CATEGORY_WEEK, {
        params: {
          country,
          week,
          order
              ...
              <Card.Body>
                {getCategoryList().map((category, categoryIndex) => (
                  <>
                    ...
                    <Row>
                      <Col xl={1}>
                        <span className="d-block py-2 pl-2 mb-2 text-capitalize fw-bold">
                          {category.name}
                        </span>
                      </Col>
                      <Col xl={11}>
