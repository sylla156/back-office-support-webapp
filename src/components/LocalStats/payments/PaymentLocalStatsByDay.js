...
import {APPKEY, LOCAL_STATS_COMMISSION_BY_DAY} from "../../../pages/constante/Const";
...
export default () => {
    ...
    const getSuccessfulPaymentCommissionByDay = () => {
        ...
        setErrorData(null);
        axios
            .get(LOCAL_STATS_COMMISSION_BY_DAY, {
                headers: {
                    AppKey: APPKEY,
                                            ...
                                            <Col xl={11}>
                                                {comIndex === 0 && (
                                                    <Row className="bg-light rounded rounded-lg py-1 mb-2 fw-bold text-muted">
                                                        <Col xl={2}>
                                                            <span className="d-block">Heure</span>
                                                        </Col>
                                                        <Col xl={2}>
