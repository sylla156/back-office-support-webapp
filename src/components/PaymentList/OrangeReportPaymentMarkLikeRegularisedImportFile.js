...
import { APPKEY, MARK_ORANGE_REPORT_PAYMENT_LIKE_REGULARISED } from "../../pages/constante/Const";
import { Routes } from "../../routes";

export const OrangeReportPaymentMarkLikeRegularisedImportFile = (props)=> {
  ...
  const postFile = ()=> {
    ...
    axios
      .post(
        MARK_ORANGE_REPORT_PAYMENT_LIKE_REGULARISED,
        formData,
        {
          headers: {
