...
export const TransactionsTable = (props) => {
  const tableTransfer = props["tableTransfer"];
        ...
        <Table hover className="user-table align-items-center">
          <thead>
            <tr>
              ...
              <th className="border-bottom">Merchant Id</th>
              {/* <th className="border-bottom">Description</th> */}
              <th className="border-bottom">Montant</th>
              <th className="border-bottom">Monnaie</th>
          ...
          <tbody>
            {tableTransfer.map(t => <TableRow key={`transaction-${t.id}`} {...t}/>)}
          </tbody>
        </Table>
      </Card.Body>
    </Card>
    ...
    <Card border="light" className="table-wrapper table-responsive shadow-sm">
      <Card.Body className="pt-0">
        <Table hover className="user-table align-items-center">
          ...
          <tbody>
            {status.map(t => <TableRow key={`transaction-${t.invoiceNumber}`} {...t} />)}
          </tbody>
        </Table>
        {/* <Card.Footer className="px-3 border-0 d-lg-flex align-items-center justify-content-between">
          ...
          <small className="fw-bold">
            Showing <b>{totalTransactionsStatus}</b> out of <b>25</b> entries
          </small>
        </Card.Footer> */}
      </Card.Body>
    </Card>
