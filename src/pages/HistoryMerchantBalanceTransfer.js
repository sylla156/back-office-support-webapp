...
import {
  APPKEY,
  HISTORY_MERHCANT_BALANCE_TRANSFER,
  HISTORY_MERHCANT_BALANCE_TRANSFER_PARAMS,
...
export default () => {
  ...
  const getHistoryMerchantBalanceCollection = () => {
    setIsLoaded(false);
    axios
      .get(HISTORY_MERHCANT_BALANCE_TRANSFER, {
        headers: {
          AppKey: APPKEY,
          authenticationtoken: cookies.token,
        },
        params: {
          type: HISTORY_MERHCANT_BALANCE_TRANSFER_PARAMS,
          day: dateFormated,
        },
      })
      .then((result) => {
