...
import {
  APPKEY,
  HISTORY_PROVIDER_BALANCE_COLLECTION,
  HISTORY_PROVIDER_BALANCE_COLLECTION_PARAMS,
...
export default () => {
  ...
  const getHistoryMerchantBalanceCollection = () => {
    setIsLoaded(false);
    axios
      .get(HISTORY_PROVIDER_BALANCE_COLLECTION, {
        headers: {
          AppKey: APPKEY,
          authenticationtoken: cookies.token,
        },
        params: {
          type: HISTORY_PROVIDER_BALANCE_COLLECTION_PARAMS,
          day: dateFormated,
        },
      })
      .then((result) => {
