...
export const REFRESH_PAYMENT_STATUS = "/status-confirmation/refresh-payment-status";
export const REFRESH_TRANSFER_STATUS = "/status-confirmation/refresh-transfer-status";
