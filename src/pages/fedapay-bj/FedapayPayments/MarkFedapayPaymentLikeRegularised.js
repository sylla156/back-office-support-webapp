...
export default () => {
    ...
    const exportData = () => {
        ...
        axios.get(EXPORT_FEDAPAY_REPORT_PAYMENT_MARK_LIKE_REGULARISED, {
            params: {
                from: startDate,
                to: endDate,
                csv: true,
    ...
    return (
        <>
                ...
                <Col xs={12} md={3} lg={3} className="px-2 mt-4">
                    <div className="mt-3 mb-4">
                        ...
                        <Button
                            ...
                            variant="primary"
                            type="button"
                            onClick={() => getMarkFedapayReportPaymentListRegularised()}
                        >
                            Filtrer
                        </Button>
            ...
            {isLoaded ? (
                <Row>
                    <MarkFedapayPaymentLikeRegularisedList
                        key={version}
                        ...
                        userCanAddFedapayPaymentRegularised={userCanAddFedapayPaymentRegularised}
                    />
                </Row>
            ) : (
                <div className="d-flex justify-content-center">
