...
export default () => {
    ...
    const [fedapayReportPaymentList, setFedapayReportPaymentList] = useState([]);
    ...
    return (
        <>
            <FedapayReportPaymentImportFile onRefresh={incrementVersion} />
                ...
                <Col xs={12} md={3} lg={6} className="px-2 mt-4">
                    <div className="mt-3 mb-4">
                        ...
                        <Button
                            ...
                            variant="primary"
                            type="button"
                            onClick={() => getFedapayReportPayment()}
                        >
                            Filtrer
                        </Button>
                    </div>
            ...
            {userCanUpdateLocalData && <MakeFedapayAndLocalPaymentReconciliation onRefresh={incrementVersion} userCanUpdateLocalData={userCanUpdateLocalData} />}
            {
                isLoaded ? <Row>
                    <FedapayReportPaymentList
                        key={version}
                        listInfo={fedapayReportPaymentList}
                        count={count}
