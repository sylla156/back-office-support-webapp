...
import {APPKEY, FEDAPAY_REPORT_TRANSFER_UPLOAD_URL} from "../../constante/Const";

export const FedapayReportTransferImportFile = (props) => {
    ...
    const postFile = () => {
        ...
        axios.post(FEDAPAY_REPORT_TRANSFER_UPLOAD_URL, formData, {
            headers:{
