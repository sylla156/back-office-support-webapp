...
export default () => {
    ...
    return (
        <>
                ...
                <Col xs={12} md={3} lg={3} className="px-2 mt-4">
                    <div className="mt-3 mb-4">
                        ...
                        <Button
                            ...
                            variant="primary"
                            type="button"
                            onClick={() => getMarkFedapayReportTransferListRegularised()}
                        >
                            Filtrer
                        </Button>
            ...
            {isLoaded ? (
                <Row>
                    <MarkFedapayTransferLikeRegularisedList
                        key={version}
                        ...
                        userCanAddWavePaymentRegularised={userCanAddFedapayPaymentRegularised}
                    />
                </Row>
            ) : (
                <div className="d-flex justify-content-center">
