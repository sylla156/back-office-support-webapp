...
export default () => {
    ...
    const [transactionType, setType] = useState("PAIEMENT");
    ...
    const userCanAddIntouchPaymentRegularised = cookies.user.canAddPaymentRegularised;
    ...
    return (
        <>
                ...
                <Col xs={12} md={3} lg={3} className="px-2 mt-4">
                    <div className="mt-3 mb-4">
                        ...
                        <Button
                            ...
                            variant="primary"
                            type="button"
                            onClick={() => getMarkIntouchReportPaymentListRegularised()}
                        >
                            Filtrer
                        </Button>
            ...
            {isLoaded ? (
                <Row>
                    <MarkIntouchPaymentLikeRegularisedList
                        key={version}
