...
export default () => {
    ...
    return (
        <>
                ...
                <Col xs={12} md={3} lg={6} className="px-2 mt-4">
                    <div className="mt-3 mb-4">
                        ...
                        <Button
                            ...
                            variant="primary"
                            type="button"
                            onClick={() => getIntouchReportTransfer()}
                        >
                            Filtrer
                        </Button>
                    </div>
            ...
            {userCanUpdateLocalData && <MakeIntouchAndLocalTransferReconciliation onRefresh={incrementVersion} userCanUpdateLocalData={userCanUpdateLocalData} />}

            {
                isLoaded ? <Row>
                    <IntouchReportTransferList 
                        key={version}
                        listInfo={intouchReportTransferList}
                        count={count}
