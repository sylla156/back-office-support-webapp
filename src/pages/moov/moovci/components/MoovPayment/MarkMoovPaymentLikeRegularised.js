...
import {MarkMoovPaymentLikeRegularisedList} from './MarkMoovPaymentLikeRegularisedList';
...
export default () => {
    ...
    const getMarkMoovReportPaymentListRegularised = () => {

        setIsLoaded(false)
        setErrorData(null)
        axios.get(GET_MARK_MOOV_REPORT_PAYMENT_LIKE_REGULARISED, {
            params: {
                from: startDate,
                to: endDate,
            },
    ...
    useEffect(() => {
        ...
        getMarkMoovReportPaymentListRegularised();
    ...
    return (
        <>
                ...
                <Col xs={12} md={3} lg={3} className="px-2 mt-4">
                    <div className="mt-3 mb-4">
                        ...
                        <Button
                            ...
                            variant="primary"
                            type="button"
                            onClick={() => getMarkMoovReportPaymentListRegularised()}
                        >
                            Filtrer
                        </Button>
            ...
            {isLoaded ? (
                <Row>
                    <MarkMoovPaymentLikeRegularisedList
                        key={version}
