...
import { APPKEY, GET_LOCAL_PAYMENT_DATA, GET_LOCAL_MOOV_REPORT_TRANSFER_RECONCILIATION_DATA } from "../../../../constante/Const";
import { format } from "date-fns";
import AxiosWebHelper from "../../../../../utils/axios-helper";
import { Routes } from "../../../../../routes";


export const MakeMoovAndLocalTransferReconciliation = (props) => {
    ...
    const makeReconciliation = () => {
        ...
        axios.get(GET_LOCAL_MOOV_REPORT_TRANSFER_RECONCILIATION_DATA, {
            params: {
                from: startDate,
                to: endDate
            },
