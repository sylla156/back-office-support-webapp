...
export default () => {
    ...
    const userCanAddMoovTransferRegularised = cookies.user.canAddPaymentRegularised;
    ...
    const exportData = () => {
        ...
        axios.get(EXPORT_MOOV_REPORT_TRANSFER_MARK_LIKE_REGULARISED, {
            params: {
                from: startDate,
                to: endDate,
            },
    ...
    return (
        <>
                ...
                <Col xs={12} md={3} lg={3} className="px-2 mt-4">
                    <div className="mt-3 mb-4">
                        ...
                        <Button
                            ...
                            variant="primary"
                            type="button"
                            onClick={() => getMarkMoovReportTransferListRegularised()}
                        >
                            Filtrer
                        </Button>
            ...
            {isLoaded ? (
                <Row>
                    <MarkMoovTransferLikeRegularisedList
                        key={version}
