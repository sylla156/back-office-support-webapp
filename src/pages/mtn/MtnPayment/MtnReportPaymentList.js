...
export const MtnReportPaymentList = (props) => {
                    ...
                    <Table hover className="user-table align-items-center">
                        <thead>
                            <tr>
                                ...
                                <th className="border-bottom">Numéro de l'emetteur</th>
                        ...
                        <tbody>
                            {listInfo.map((t) => (
                                <MtnReportPaymentList.TableRow key={`transaction-${t.id}`} {...t} />
                            ))}
                        </tbody>
                    </Table>
...
MtnReportPaymentList.TableRow = (props) => {
    ...
    return (
        <>
            <tr>
                ...
                <td>
                    <span className="fw-normal">{fromNumber}</span>
                </td>
                <td>
