...
export default () => {
    ...
    const [mtnReportTransferList, setMtnReportTransferList] = useState([]);
    ...
    return(
        <>
            <MtnReportTransferImportFile onRefresh={incrementVersion} />
            ...
            {userCanUpdateLocalData && <MakeMtnAndLocalTransferReconciliation onRefresh={incrementVersion} userCanUpdateLocalData={userCanUpdateLocalData} />}

            {
                isLoaded ? <Row>
                    <MtnReportTransferList
                        key={version}
                        listInfo={mtnReportTransferList}
                        count={count}
