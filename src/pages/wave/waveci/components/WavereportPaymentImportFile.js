...
import { APPKEY, WAVE_REPORT_PAYMENT_UPLOAD_URL } from "../../../constante/Const";
import { Routes } from "../../../../routes";

export const WaveReportPaymentImportFile = (props) => {
    ...
    const postFile = () => {
        ...
        axios.post(WAVE_REPORT_PAYMENT_UPLOAD_URL,formData,{
            headers:{
